...
static family allFamilies[] = {
        ...
        {0x5a18069b, "Infineon (Cypress) FX2"},
        ...
        {0x7eab61ed, "espressif ESP8266"},
        {0x7f83e793, "NXP KL32L2x"},
        {0x8fb060fe, "ST STM32F407VG"},
        {0xada52840, "Nordic NRF52840"},
        {0xbfdd4eee, "espressif ESP32-S2"},
        {0xc47e5767, "espressif ESP32-S3"},
        {0xd42ba06c, "espressif ESP32-C3"},
        {0x2b88d29c, "espressif ESP32-C2"},
        {0x332726f6, "espressif ESP32-H2"},
